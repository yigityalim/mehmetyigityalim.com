    ...
    return (
        <>
            <div className='relative w-full md:px-10'>
                ...
                <h1 className='absolute bottom-4 left-0 right-0 scroll-m-20 pl-4 text-center text-5xl font-extrabold tracking-tight text-black dark:text-white md:static md:mt-6 md:w-full md:pl-0 md:pr-8 md:text-start md:text-6xl'>
                    Mehmet Yiğit
                </h1>
            </div>
        </>

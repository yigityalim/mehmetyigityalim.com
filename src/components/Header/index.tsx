...
export default function Header(): React.JSX.Element {
    ...
    return (
        <>
            <header
                className={cn(
                    'container sticky top-0 z-[41] mx-auto flex w-full items-center justify-between bg-white px-8 py-6 transition-colors duration-300 dark:bg-wash-dark-2 md:p-10 lg:p-12 xl:p-16',
                    {
